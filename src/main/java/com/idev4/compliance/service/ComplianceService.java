...
//    private final MwBrnchRepository mwBrnchRepository;
    ...
    public ComplianceService(EntityManager em, MwQstnrRepository mwQstnrRepository,
    		...
    		MwBrnchRepository mwBrnchRepository, MwAdtVstRepository mwAdtVstRepository,
    		MwAdtVstSrvyRepository mwAdtVstSrvyRepository, MwAdtFndngRepository mwAdtFndngRepository) {
    	this.em=em;
    ...
    public TabDto getDataForTab(String lanId) {
    	...
    	if(emp!=null) {
    		dto.mw_adt_vst = mwAdtVstRepository.findAllByAssignedToAndCrntRecFlg(emp.getEmpSeq(), true);
    	}
    	return dto;
    }
    @Transactional
    ...
    public ResponseEntity updateStatusOfVst(Long vstSeq, String curUser){
    	...
    	if(exVst!=null) {
	    	...
	    	List<MwAdtVst> vsts = mwAdtVstRepository.findAllByAssignedToAndVisitStsKeyAndCrntRecFlg(exVst.getAssignedTo(), inProgressStatusKey, true);
